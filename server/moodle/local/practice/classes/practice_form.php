...
class practice_form extends moodleform {
    public function definition() {
	   ...
	   $mform->addRule('firstname', 'This field cannot be left blank', 'required', null, 'server');


       $mform->addElement('text','lastname','Last name');
       $mform->setType('lastname',PARAM_TEXT);
	   $mform->addRule('lastname', 'This field cannot be left blank', 'required', null, 'server');

       $mform->addElement('text','email','Email');
       $mform->setType('email',PARAM_EMAIL);
	   $mform->addRule('email', 'Please enter a valid email address', 'required', null, 'server');
